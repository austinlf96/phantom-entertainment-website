<!-- [INFO] Type: 2 Lane Bungee Page - Details: Explore the 2 Lane Bungee. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">2 Lane Bungee</li>
</ul>

<div>
    <h3>2 Lane Bungee</h3>
    <p>The classic Bungee Run is always a crowd favorite!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>Two players are attached to bungee cords and run towards the front as far as they can. Once they are stretched out, the players stick velcro "bricks" on the middle wall. The player with the brick closest to the front wins!</p>
                    <p>Two players not enough? Try out our <a href="page.php?title=3lanebungee&extra=none">3 Lane Bungee</a>!</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 35'L x 10'W x 9'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 35'L x 12'W x 10'L </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        ...
                        title="Additional Limitations to Operate the Unit Safely">
                            <span><i class="fal fa-exclamation-circle text-warning"></i> Limitations</span>Min. player height: 48''</a>
                    </div>
                </div>
            </div>
        </div>
