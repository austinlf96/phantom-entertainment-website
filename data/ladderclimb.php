<!-- [INFO] Type: Ladder Climb Page - Details: Explore the Ladder Climb. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Ladder Climb</li>
</ul>

<div>
    <h3>Ladder Climb</h3>
    <p>It's not on our <a href='page.php?title=ninjawarrior&extra=none'>Ninja Warrior Obstacle Course</a>, but you might recognize this ladder obstacle from the show!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>Race against a friend as you try to climb one of our Unclimbable Ladders.  The first to the top who rings the bell wins!
                    But we don't expect you to make it, that's why we've provided the soft inflated mat below when you fall. Great fun for all ages.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 14'L x 4'W x 8'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 14'L x 4'W x 8'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
