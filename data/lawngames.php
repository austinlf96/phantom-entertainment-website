<!-- [INFO] Type: Lawn Games Page - Details: Explore the Lawn Games. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Lawn Games</li>
</ul>

<div>
    <h3>Lawn Games</h3>
    <p>Lawn Games is the perfect addition to any picnic, party, corporate or college event.</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>You can pick any three (3) of the games below:</p>
                    <ul>
                        <li>Giant Pong</li>
                        <li>Giant Jenga</li>
                        <li>Giant Chess</li>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 40'L x 23'W x 11'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 40'L x 23'W x 11'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        ...
                        title="Max Users Participating at Once">
                            <span><i class="fal fa-users text-info"></i> Max Participants</span> None</a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
