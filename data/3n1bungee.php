<!-- [INFO] Type: 3N1 Bungee  Page - Details: Explore the 3N1 Bungee . [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">3N1 Bungee </li>
</ul>

<div>
    <h3>3N1 Bungee </h3>
    <p>It's a bungee run, it's an obstacle, and finally it's a slam dunker!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>Starting at the beginning, the participant is strapped to a bungee cord. Then they need to run through the obstacles. 
                    Finally, dunk the basketball at the end.. The challenge is to see who can run down and dunk it thru the hoop the fastest.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 38'L x 11'W x 10'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 38'L x 11'W x 10'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Individual 110v - 20amp Breaker">
                            <span><i class="fal fa-plug text-info"></i> Power</span>1 AC Circuits</a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        ...
                        title="Additional Limitations to Operate the Unit Safely">
                            <span><i class="fal fa-exclamation-circle text-warning"></i> Limitations</span>Min. player height: 36''</a>
                    </div>
                </div>
            </div>
        </div>
