<!-- [INFO] Type: *Equipment Name* Page - Details: Explore the *Equipment Name*. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li id="dynamic-crumb" class="breadcrumb-item">*Equipment Name*</li>
</ul>

<div>
    <h3 id="title">*Equipment Name*</h3>
    <p id="summary">*Equipment Quick Description*</p>
</div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Additional Limitations to Operate the Unit Safely">
                            <span><i class="fal fa-exclamation-circle text-warning"></i> Limitations</span> limits </a>
                    </div>
                </div>
            </div>
        </div>
