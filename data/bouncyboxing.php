<!-- [INFO] Type: Bouncy Boxing Page - Details: Explore the Bouncy Boxing. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Bouncy Boxing</li>
</ul>

<div>
    <h3>Bouncy Boxing</h3>
    <p>Let's get ready to <b><i>rrrrrrrrrrrrrrruuuuuuummmmmbbbbbllllleeeeee</i></b> with the Bounxy Boxing inflatable!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>This inflatable boxing ring is the highlight of any event. Using the over-sized boxing gloves, two boxers rumble and attempt to stay on their feet</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 25'L x 25'W x 12'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 25'L x 25'W x 12'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
