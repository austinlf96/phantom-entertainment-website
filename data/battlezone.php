<!-- [INFO] Type: Battlezone Joust Page - Details: Explore the Battlezone Joust. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Battlezone Joust</li>
</ul>

<div>
    <h3>Battlezone Joust</h3>
    <p>Looking for more of a challenge than the <a href="page.php?title=gladiatorjoust&extra=none">Gladiator Joust</a> can provide? For the ultimate duel, try our Battlezone Joust</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>This crazy game is a mix between jousting and walking the plank. Two participants meet in the middle of the yellow plank and joust it out until the winner is still standing. Knock your opponent 
                    off the plank into the pit of inflatable softness, before it's too late!</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 31'L x 27'W x 15'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 32'L x 27'W x 16'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Individual 110v - 20amp Breaker">
                            <span><i class="fal fa-plug text-info"></i> Power</span>3 AC Circuits</a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
