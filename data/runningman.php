<!-- [INFO] Type: Running Man Page - Details: Explore the Running Man. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Running Man</li>
</ul>

<div>
    <h3 id="title">Running Man</h3>
    <p id="summary">The Running Man is one of our most unique units! It's a mixture of <a href="page.php?title=airbunkerball&extra=none">Air Bunker Ball</a> and 
    <a href="page.php?title=inflatables&extra=none#obstacles">Obstacle Courses</a>!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>One participant starts at one end of the unit and must navigate through the barriers and obstacles to get to the other end, grab a flag 
                    and return back to the start.....all at the same time three other people are shooting foam balls at the runner.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 31'L x 25'W x 14'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 45'L x 25'W x 15'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        ...
                        title="Max Users Participating at Once">
                            <span><i class="fal fa-users text-info"></i> Max Participants</span> 4? </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
