<!-- [INFO] Type: Bubble Bowling Page - Details: Explore the Bubble Bowling. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Bubble Bowling</li>
</ul>

<div>
    <h3>Bubble Bowling</h3>
    <p>Every frame is a <i>strike</i> when you <i>are</i> the bowling ball! Introducing Bubble Bowling, the one of a kind bowling experience.</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>No bowling alley around? Time to try our Bubble Bowling. Hop inside the inflated sphere and knock down the pins yourself 
                    and make a perfect strike! You'll be laughing so hard you'll have a hard time making the ball go where you want and you'll have a blast doing it!</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 40'L x 17'W x 10'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 40'L x 17'W x 10'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
