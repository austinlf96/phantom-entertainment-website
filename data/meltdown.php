<!-- [INFO] Type: Meltdown Page - Details: Explore the Meltdown. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Meltdown</li>
</ul>

<div>
    <h3 id="title">Meltdown</h3>
    <p id="summary">Meltdown is a variant on our <a href="page.php?title=mechanicalbull&extra=logslammer">Log Slammer</a> and our <a href="page.php?title=kapow&extra=none">Kapow</a>.
    Meltdown is an 8 player action game, which challenges your stamina, agility and reactions!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>Not one but two spinning boom arms try to knock you off your podium. You have to duck underneath or jump over the foam boom. Who will be the last one standing?
                    The game is an octagon inflatable, with 8 removable podiums for your participants. We have a variable speed control on the console that increases 
                    or decreases the speed of the spin,making it as easy or difficult as you wish! Meltdown is a fun game for the whole family.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 32' Diameter x 10'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 32' Diameter x 10'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        ...
                        title="Max Users Participating at Once">
                            <span><i class="fal fa-users text-info"></i> Max Participants</span> 8 </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
