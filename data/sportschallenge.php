<!-- [INFO] Type: Sports Challenge Page - Details: Explore the Sports Challenge. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Sports Challenge</li>
</ul>

<div>
    <h3>Sports Challenge</h3>
    <p>Push yourself to your limit with our Sports Challenge bungee basketball!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>The Sports Challenge is the newest version of the classic Bungee Run game. Two players are attached to the same bungee and then run opposite directions in order to shoot basketballs. This game is as thrilling to watch as it is to play!</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 39'L x 15'w x 9.5'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
