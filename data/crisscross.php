<!-- [INFO] Type: Criss Cross Page - Details: Explore the Criss Cross. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Criss Cross</li>
</ul>

<div>
    <h3>Criss Cross</h3>
    <p>Learn what it feels like to be a hampster in the Criss Cross Zorb Ball race game! </p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>The Criss Cross is a great new item that puts two people into giant inflated hamster balls. The two people race each other to the far end, 
                    turn around, and race back to the start. Keep in mind how long the item is when you are planning your event.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 100'L x 40'w x 7'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 100'L x 40'w x 7'H </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
