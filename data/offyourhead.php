<!-- [INFO] Type: Off Your Head - Medievil Page - Details: Explore the Off Your Head - Medievil. [INFO]-->
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Off Your Head - Medievil</li>
</ul>

<div>
    <h3>Off Your Head - Medievil</h3>
    <p>Off Your Head is a perfect compliment to the <a href='page.php?title=gladiatorjoust&extra=none'>Gladiator Joust</a> or the <a href='page.php?title=battlezonejoust&extra=none'>Battlezone Joust</a>!</p>
</div>
        ...
        <div class="col-lg-7 col-md-12 p-0">
            ...
            <div class="card shadow-sm m-1">
                ...
                <div class="card-body p-2">
                    <p>This is an excellent medieval competition between two players.
                    The object of the game is to knock the head of your opponent off his body.
                    Comes with two costumes, poles, and game mat.</p>
                    <p>Want something a little more sporty? Try out our <a href='page.php?title=offyourhockey&extra=none'>Off Your Head - Hockey</a></p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        title="Actual Dimensions of the Unit">
                            <span><i class="fal fa-ruler-triangle text-info"></i> Dimensions</span> 16' Diameter </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Recommended Total Space Needed for Setup">
                            <span><i class="fal fa-shoe-prints text-info"></i> Footprint</span> 16' Diameter </a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        title="Individual 110v - 20amp Breaker">
                            <span><i class="fal fa-plug text-info"></i> Power</span>Not required</a>
                        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
                        data-toggle="tooltip" 
                        ...
                        title="Additional Limitations to Operate the Unit Safely">
                            <span><i class="fal fa-exclamation-circle text-warning"></i> Limitations</span>None</a>
                    </div>
                </div>
            </div>
        </div>
